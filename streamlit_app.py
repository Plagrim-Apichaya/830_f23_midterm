...
if page == "Home":
    ...
    st.write("The core dataset for this project will focus on three fundamental agricultural products: **cassava, rice, and corn**. **Monthly price records in Bangkok from January 2014 to June 2019 will be analyzed**. In addition to this primary dataset, we will incorporate three distinct datasets, each with the potential to impact agriculture prices and inflation.")
