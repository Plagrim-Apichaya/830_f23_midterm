...
if page == "Home":
    ...
    st.subheader("Welcome to webapp of data analysis with the historical agriculture price data recorded monthly from January 2001 to March 2020")
